...
# **ヒートマップ**とは，
# 
# > 抽象的なデータを可視化する手法の一。行列の形式をもつ数値データから、行または列の要素が類似するパターンを抽出する。また、ウェブページで閲覧者がどの部分に注目し、どのリンクをクリックしたかを色分けし、見やすくしたものが知られる。
# 
...
# 1. 一定以上の長期連載作品（例えば100週以上）に絞り，雑誌毎の連載陣の移り変わりを可視化してみましょう
#     - 横軸：年代
#     - 縦軸：作品名
#     - 色：掲載週数
# 2. 一定以下の短期連載作品（例えば10週以下）数を掲載年・雑誌ごとに集計し，長期連載がいかに難しいか可視化しましょう
#     - 横軸：年代
#     - 縦軸：雑誌
#     - 色：短期連載作品数
