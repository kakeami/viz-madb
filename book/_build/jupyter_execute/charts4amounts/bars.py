...
# **棒グラフ（Bar Chart）** とは，主に質的変数を対象にして，**棒の長さ**で数量を表すグラフです．棒を縦方向に並べることもありますし，横方向に並べることもあります．質的変数の量を見る最も一般的な方法の一つです．

# ![bars](../figs/charts/bars.png)

# 例えば上図は，作品ごとの合計掲載週数を表した棒グラフです．
# なお，棒グラフにはいくつか種類がありますが，このページでは**積上げ棒グラフ**と**集合棒グラフ**について紹介します．
