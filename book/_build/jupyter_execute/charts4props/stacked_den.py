...
# **積上げ密度プロット（Stacked Density Plot）**は，主に**連続的に変化する**質的変数に対して，面積で比率の変遷を表現するグラフです．
# 横軸に連続的に変化する変数（例えば日付），縦軸に質的変数の比率を取ります．
# [円グラフ]()や[積上げ棒グラフ]()と同様に，比率同士の比較が難しいという欠点があります．
# また，あくまでも**比率**の推移であり，**絶対値**の推移ではないことにも注意が必要です．
...
# また，あくまでも**比率（作品数のシェア）**の推移であり，**絶対値（作品数）**の推移ではないことに注意が必要です．
