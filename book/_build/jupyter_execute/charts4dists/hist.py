...
# **ヒストグラム（Histogram）** とは，量的変数に対して，分布の形状を **長方形の組合せ** で表すグラフです．
# 横軸に変数の **区間** ，縦軸にその区間に属するデータの数（ **度数** ）を取ります．
# **柱状図** とも呼ばれます．
# 量的変数の分布を見る際，利用頻度が高い図です．

# ![](../figs/charts/histogram.png)

# 例えば上図は，マンガ作品ごとの平均掲載位置の分布を表したヒストグラムです．`0.6`から`0.7`にピークがあることがわかります．

# ヒストグラムには様々な種類がありますが，ここでは**累積ヒストグラム**と**積上げヒストグラム**を紹介します．

# **累積ヒストグラム** とは，下図のように累積分布を表現したヒストグラムです．これにより **特定の値以下（以上）** のデータがどの程度存在するかを確認することができます．

# ![](../figs/charts/cumul_histo.png)

# **積上げヒストグラム**とは，下図のように横軸とは他の変数によって度数を分割し，縦に積上げたヒストグラムです．これにより，分布を構成する要素の内訳を確認しやすくなります．

# ![](../figs/charts/stacked_histo.png)
